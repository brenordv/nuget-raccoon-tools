...
public class ListExtensionsTests
{
    ...
    #region RemoveAll
    [Fact]
    public void RemoveAll_List_ShouldRemoveMatchingItems()
    {
        // Arrange
        var list = new List<int> { 1, 2, 3, 4, 5 };

        // Act
        var removedCount = list.RemoveAll(x => x % 2 == 0);
    ...
    [Fact]
    public void RemoveAll_EmptyList_ShouldReturnZero()
    {
        // Arrange
        var list = new List<int>();
    ...
    [Fact]
    public void RemoveAll_NoMatchingElements_ShouldReturnZero()
    {
        // Arrange
    ...
    [Fact]
    public void RemoveAll_AllMatchingElements_ShouldReturnCountAndEmptyList()
    {
        // Arrange
